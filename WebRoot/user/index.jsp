  ...
  <body>
  	<ul class="fly-panel-main fly-list-static layui-nav layui-nav-tree  layui-col-md2" lay-filter="menu" style="margin-right: 10px;">
				  ...
				  <li class="layui-nav-item item-menu">
				    <a href="javascript:void(0);" data-url="./manager/user.do"><i class="layui-icon">&#xe602;</i><span>我的信息</span></a>
				  </li>
				  <li class="layui-nav-item item-menu">
				    <a href="javascript:void(0);" data-url="./manager/course.do"><i class="layui-icon">&#xe602;</i><span>我的学生</span></a>
				  </li>
				  <li class="layui-nav-item item-menu">
				    <a href="javascript:void(0);" data-url="./manager/notice.do"><i class="layui-icon">&#xe602;</i><span>我的课程</span></a>
				  </li>
				  
				  <li class="layui-nav-item item-menu">
				    <a href="javascript:void(0);" data-url="./manager/notice.do"><i class="layui-icon">&#xe602;</i><span>我的消息</span></a>
				  </li>
	 	</ul>
